...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/vishwa-rathinam-01a934282/)
...
- 🧠 **LLM Fine-Tuning** with LoRA / QLoRA / PEFT — taking models from generic to surgical
- ⚡ **CUDA Kernel Optimization** — squeezing every FLOP from the GPU
- 🛡️ **CTF Labs + Ethical Hacking** — because understanding attacks builds better defenses
- 🚀 **ML Deployment Pipelines** — FastAPI + Docker + MLflow to production
...
```
Supervised Learning    → Linear/Logistic Regression · Decision Trees · SVM · K-Means
Deep Learning          → MLP · CNN (Malaria Detection) · RNN (Stock Prediction) · Autoencoder · NER
Reinforcement Learning → Q-Learning · SARSA · Monte Carlo · Policy/Value Iteration · MDP
LLMs & GenAI           → HuggingFace · LoRA / QLoRA / PEFT · Prompt Engineering · Model Deployment
Mathematics            → Gaussian · Poisson · Binomial · QR/LU Decomp · Eigenvalues · Matrix Rank
```
...
```
Matrix Multiplication   ·   GPU Vector Summation   ·   Warp Divergence Analysis
Shared Memory Optimization   ·   Kernel Launch Configuration   ·   GPU Memory Hierarchy
```

---

### 🔩 Embedded Systems · OS Internals · Hardware
...
```
Embedded (ARM LPC2148)  → ADC · UART · LCD · Keypad · Timers · Interrupts
OS & Linux IPC          → Pipes · Shared Memory · Semaphores · Msg Queues · fork/exec
Digital Hardware        → Flip-flops · Combinational Logic · Adders · Counters
```
...
```
SQL Injection · Metasploit Exploitation · Backdoor via SET · ARP Attacks
Network Sniffing · Enumeration · Information Gathering · CTF Labs
```
...
> Deep learning model for automated malaria cell classification from microscopy images. High-accuracy CNN pipeline trained end-to-end with data augmentation and evaluation metrics.
...
> Time-series prediction with Recurrent Neural Networks. Trained on historical OHLCV data with sequence windowing, dropout regularization, and multi-step forecasting.
...
### ⚡ CUDA Parallel Matrix Engine
> GPU-accelerated matrix computation engine exploring warp divergence, shared memory tiling, and kernel optimization. Benchmarked against CPU baselines for measurable speedup.

![CUDA](https://img.shields.io/badge/CUDA-76B900?style=flat-square&logo=nvidia&logoColor=white)
![C++](https://img.shields.io/badge/C%2B%2B-00599C?style=flat-square&logo=cplusplus&logoColor=white)
![GPU](https://img.shields.io/badge/Platform-NVIDIA_GPU-76b900?style=flat-square)
...
### 🔩 ARM LPC2148 Embedded Suite
> Bare-metal embedded C programs for LPC2148 microcontroller: ADC interfacing, UART comms, LCD control, keypad scanning, timer interrupts — hardware meets software.

![Embedded C](https://img.shields.io/badge/Embedded_C-00599C?style=flat-square&logo=c&logoColor=white)
![ARM](https://img.shields.io/badge/Platform-ARM_LPC2148-0091BD?style=flat-square)
...
║  [ 🔄 ACTIVE ]  Build end-to-end CUDA-accelerated ML pipeline    ║
║  [ 🔄 ACTIVE ]  Push Top 10% on a Kaggle competition             ║
║  [ 🔄 ACTIVE ]  Ship 10+ meaningful AI/Systems projects          ║
║                                                                   ║
║  [ 🎯 QUEUED ]  CEH / Cybersecurity Certification                ║
║  [ 🎯 QUEUED ]  Contribute to 5+ open-source ML / Systems repos  ║
║  [ 🎯 QUEUED ]  Write deep-tech blogs: CUDA · RL · Embedded AI   ║
║  [ 🎯 QUEUED ]  Land ML or Systems internship at top company     ║
║  [ 🎯 QUEUED ]  Speak at a tech event or publish a paper         ║
║                                                                   ║
║  [ 🚀 NORTH STAR ]  Full-time role — AI/ML or Systems — 2026     ║
║                                                                   ║
╚═══════════════════════════════════════════════════════════════════╝
```
...
```bash
vishwa@rathinam:~$ cat thoughts.log

  [01]  ⚡  CUDA changed how I think about performance. Every ms matters.
  [02]  🧠  RL taught me patience — agents learn from failure, so do I.
  [03]  🔩  Bare-metal programming made me respect every abstraction layer.
  [04]  🔐  Security isn't a feature. It's a mindset baked in from day one.
  [05]  📊  One well-tuned model beats ten mediocre ones. Every time.
  [06]  🐛  My best bug fix came at 1am. Never underestimate a fresh pair of eyes.
  [07]  🌐  From transistors to transformers — I want to understand every layer.
  [08]  🤝  The best engineers I know: curious, relentless, and kind.
  [09]  🚀  Ship it. Iterate. Ship better. Repeat.
  [10]  💡  The gap between knowing and building is the only one worth closing.
...
<a href="mailto:vishwarathinam02@gmail.com"><img src="https://img.shields.io/badge/Email-vishwarathinam02%40gmail.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white"/></a>
<a href="https://www.linkedin.com/in/vishwa-rathinam-01a934282/"><img src="https://img.shields.io/badge/LinkedIn-Vishwa%20Rathinam-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white"/></a>
